...
public class ApngSinpleDecoder extends Decoder{
        ...
        protected Vector<ApngFrame> frames; // frames read from current file
        protected int frameCount;

        private static class ApngFrame {
                public ApngFrame(Bitmap im, int del) {
                        image = im;
                        delay = del;
                }
        ...
        public Bitmap getFrame(int n) {
                if (frameCount <= 0)
                        return null;
                n = n % frameCount;
                return ((ApngFrame) frames.elementAt(n)).image;
        }
        ...
        protected void decodeBitmapData() {
                ...
                for (code = 0; code < clear; code++) {
                        prefix[code] = 0; // X-X-X ArrayIndexOutOfBoundsException
        ...
        protected void readBitmap() {
                ...
                frames.addElement(new ApngFrame(image, delay)); // add image to frame
                // list
                if (transparency) {
                        act[transIndex] = save;
                }
